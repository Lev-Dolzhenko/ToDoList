function renderTask(task) {
  ...
  <li id="${task.id}" class='task'>
    ...
    <div class="main-block__buttons-additional none">
        <button class="button button--additional button--remake">
...
// function showPopup() {
//   listTasks.querySelectorAll('.task').forEach(function(taskOfList) {
//     taskOfList.children[0].addEventListener('click', function () {
//       taskOfList.children[1].classList.toggle('none');
//     });
//   });
...
//     if (taskElement) {
//       const additionalButtons = taskElement.querySelector('.main-block__buttons-additional');
...
// const phoneRemake = document.querySelector('.phone__remake');
// function showRemakePopup() {
//   const buttonsRemake = document.querySelectorAll('.button--remake');
//   buttonsRemake.forEach(function (buttonRemake) {
//     buttonRemake.addEventListener('click', function () {
//       phoneRemake.classList.remove('none');
//     });
//   });
// }
